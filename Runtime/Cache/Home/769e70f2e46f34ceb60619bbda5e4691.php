...
<div class="main">
    ...
    <nav class="navbar navbar-default navbar-fixed-bottom">
        <div class="container-fluid text-center">
            ...
            <div class="col-xs-3">
                <p class="navbar-text"><a href="index.php?s=/Home/User/login.html" class="navbar-link">登录</a></p>
            </div>
            <div class="col-xs-3">
                <p class="navbar-text"><a href="index.php?s=/Home/User/logout.html" class="navbar-link">注销</a></p>
            </div>
            <div class="col-xs-3">
                <p class="navbar-text"><a href="index.php?s=/Home/User/register.html" class="navbar-link">注册</a></p>
            </div>
        </div>
    </nav>
    <!--导航结束-->
    ...
    <div class="container-fluid">
        <div class="indexImg row">
            <img src="/onethink/Public/static/static/image/index.jpg" width="100%" />
        </div>
        <div class="serviceList text-center">
            <div class="container">
                <div class="row">
                    <div class="col-xs-4">
                        <a href="index.php?s=/Home/Guarantee/notice.html">
                    ...
                    <div class="col-xs-4">
                        <a href="index.php?s=/Home/Guarantee/edit.html">
