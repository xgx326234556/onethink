...
<body>
    ...
    <form action="<?php echo U('guarantee/add');?>" method="post" class="form-horizontal">
        ...
        <div class="form-item">
            ...
            <div class="controls">
                <input type="text" class="text input-large" name="tel" >
            </div>
        </div>

        <div class="form-item">
            <label class="item-label">报修内容<span class="check-tips"></span></label>
            <div class="controls">
                <input type="text" class="text input-small" name="content" >
            </div>
        </div>
        <div class="form-item">
