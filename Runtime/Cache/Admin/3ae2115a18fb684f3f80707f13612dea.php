...
<body>
    ...
    <form action="<?php echo U();?>" method="post" class="form-horizontal">
        <div class="form-item">
            <label class="item-label">报修人<span class="check-tips">(填写真实姓名)</span></label>
            <div class="controls">
                <input type="text" class="text input-large" name="name" value="">
            </div>
        </div>
        <div class="form-item">
            <label class="item-label">报修内容<span class="check-tips">（填写正确的报错信息）</span></label>
            <div class="controls">
        ...
        <div class="form-item">
            <label class="item-label">报修时间<span class="check-tips"></span></label>
            <div class="controls">
                <input type="text" class="text input-large" name="time" value="">
            </div>
        </div>
        <div class="form-item">
