...
<body>
    ...
    <div class="data-table table-striped">
        <table>
            ...
            <tbody>
            <?php if(!empty($index)): if(is_array($index)): $i = 0; $__LIST__ = $index;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$Guarantee): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td>
                            ...
                            <a class="confirm ajax-get" title="删除" href="<?php echo U('del?id='.$Guarantee['id']);?>">删除</a>
                        </td>
